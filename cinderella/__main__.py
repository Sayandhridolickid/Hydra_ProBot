...
if START_IMG is None:
    img = "https://telegra.ph/file/da89ec60fd41fbf1f5ab6.jpg"
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="DEV",url="https://t.me/Ridolickid")]]
    keyboard += [[InlineKeyboardButton(text="OUR Group ",url="http://t.me/Movievibezz")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="Contact Creator",url="https://t.me/Ridolickid")]]))
        return
